...
=======
     ...
     */
    public static function set() {
        $var = array("name", "site_address", "like", "plusone", "fbappid", "max_comments", "noregister", "forcehttps", "nocomments", "nodownload", "max_img_dir", "thumbs_fixed_width", "loc", "l33t", "reverse_menu", "hide_menu", "hide_infos", "encode_video", "ffmpeg_path", "ffmpeg_option");
        $f = fopen(Settings::$admin_settings_file, "w");
        foreach ($var as $v) {
            if (isset($_POST["$v"])) {
                fwrite($f, "$v = \"" . $_POST["$v"] . "\"\n");
