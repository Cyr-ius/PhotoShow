...
class TestUnit extends PHPUnit_Framework_TestCase {
    ...
    public static function include_all() {
        $toinclude = array(realpath(dirname(__FILE__) . "/../classes/HTMLObject.php"), realpath(dirname(__FILE__) . "/../classes/Page.php"), realpath(dirname(__FILE__) . "/../classes/File.php"), realpath(dirname(__FILE__) . "/../classes/Account.php"), realpath(dirname(__FILE__) . "/../classes/Group.php"), realpath(dirname(__FILE__) . "/../classes/Menu.php"), realpath(dirname(__FILE__) . "/../classes/GuestToken.php"), realpath(dirname(__FILE__) . "/../classes/CurrentUser.php"), realpath(dirname(__FILE__) . "/../classes/Video.php"), realpath(dirname(__FILE__) . "/../classes/Cleaning.php"), realpath(dirname(__FILE__) . "/../classes/Settings.php"));
